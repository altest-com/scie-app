...
/*"INSERT INTO ASISTENCIA VALUES ('$ID_CANDIDATO', '$ID_EVALUACION', '$NOMBRE','$PRUEBA' ,'$FECHA', '$ASISTENCIA')"*/
		$sql = "UPDATE CERTIFICADOS SET OFICIO_ENVIO = '$OFICIO_E', OFICIO_RECEPCION = '$OFICIO_R', ESTATUS_DOC = '$ESTATUS_DOC' WHERE ID_EVALUACION ='$ID_EVALUACION' AND TIPO_CERTIFICADO = '$TIPO'";

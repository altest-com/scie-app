...
$conexion->set_charset("utf8");
		...
		if ($resultado = $conexion->query("SELECT candidatos.ID_CANDIDATO, CONCAT(PRIMER_NOMBRE, \" \", SEGUNDO_NOMBRE, \" \", PRIMER_APELLIDO, \" \", SEGUNDO_APELLIDO) AS NOMBRE, $EXAMEN AS FECHA, ID_EVALUACION, CURP FROM candidatos JOIN evaluacion ON (candidatos.ID_CANDIDATO = evaluacion.ID_CANDIDATO) WHERE evaluacion.$EXAMEN = '$FECHA' ")) {

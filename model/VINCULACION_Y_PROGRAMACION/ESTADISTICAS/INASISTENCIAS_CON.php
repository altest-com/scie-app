...
$conexion->set_charset("utf8");
	...
	if ($result = $conexion->query("SELECT COUNT(*) AS CANTIDAD  FROM inasistencias_mensuales I LEFT JOIN evaluacion EV ON I.ID_EVALUACION = EV.ID_EVALUACION LEFT JOIN oficios O ON I.ID_EVALUACION = O.ID_EVALUACION LEFT JOIN candidatos CA ON CA.ID_CANDIDATO = I.ID_CANDIDATO WHERE YEAR(I.FECHA) = '$ANO' AND MONTH(I.FECHA) = '$MES' AND I.ID_CANDIDATO = '$ID_CANDIDATO'")) {

...
$conexion->set_charset("utf8");
	...
	if($lol == "total" || $lol ==""){
		...
		if ($result = $conexion->query("SELECT COUNT(*) AS cantidad FROM evaluacion EV LEFT JOIN candidatos CA ON CA.ID_CANDIDATO = EV.ID_CANDIDATO LEFT JOIN oficios O ON O.ID_EVALUACION = EV.ID_EVALUACION WHERE EV.FECHA_EVALUACION BETWEEN '$FECHA1' AND '$FECHA2'".$lol)) {

...
*/
	if ($result = $conexion->query("SELECT * FROM medico_bitacora3 T INNER JOIN candidatos C ON C.ID_CANDIDATO = T.ID_CANDIDATO INNER JOIN evaluacion E ON E.ID_CANDIDATO = T.ID_CANDIDATO WHERE E.FECHA_EXAMEN_TOXICOLOGICO BETWEEN '$FECHA1' AND '$FECHA2'")) {

...
function Verificar_DOMICILIO($conexion,$id_c, $id_e){
	
	$consulta = $conexion->prepare('SELECT * FROM reporte_entorno WHERE ID_EVALUACION = :ide');
	$consulta->execute(array(':ide' => $id_e));
...
function Verificar_DESCARGA($conexion,$id_e){
	
	$consulta = $conexion->prepare('SELECT * FROM descarga WHERE FECHA = :ide');
	$consulta->execute(array(':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_ANTECEDENTES($conexion,$id_c, $id_e){
	
	$consulta = $conexion->prepare('SELECT * FROM investigacion_antecedentes WHERE ID_EVALUACION = :ide');
	$consulta->execute(array(':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_ANTECEDENTES2($conexion,$id_c, $id_e){
	
	$consulta = $conexion->prepare('SELECT * FROM reporte_antecedentes WHERE ID_EVALUACION = :ide');
	$consulta->execute(array(':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_CALI($conexion,$id_c, $id_e){
	...
	$consulta = $conexion->prepare('SELECT * FROM calificacion WHERE ID_CANDIDATO = :idc AND ID_EVALUACION = :ide');
...
function Verificar_report1($conexion,$id_c, $id_e){
...
function Verificar_claves($conexion,$fecha){
	
	$consulta = $conexion->prepare('SELECT * FROM ise_claves_local WHERE FECHA = :idc');
	$consulta->execute(array(':idc' => $fecha));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
	}else{
...
function Verificar_historia($conexion, $id_e){
	$consulta = $conexion->prepare('SELECT * FROM historia_datos_generales WHERE ID_EVALUACION = :ide');
	$consulta->execute(array(':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_concentrado($conexion,$id_c, $id_e){
	$consulta = $conexion->prepare('SELECT * FROM concentrado_ise1 WHERE ID_CANDIDATO = :idc AND ID_EVALUACION = :ide');
	$consulta->execute(array(':idc' => $id_c,':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_DIGIS($conexion,$id_c, $id_e){
	$consulta = $conexion->prepare('SELECT * FROM digiscan WHERE ID_CANDIDATO = :idc AND ID_EVALUACION = :ide');
	$consulta->execute(array(':idc' => $id_c,':ide' => $id_e));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
...
function Verificar_PLATAFORMA($conexion,$id_c){
	$consulta = $conexion->prepare('SELECT * FROM PLATAFORMA_MEXICO WHERE ID_EVALUACION = :idc');
	$consulta->execute(array(':idc' => $id_c));
	$resultado = $consulta->fetch();
	if($resultado == null){
		return "incorrecto";
